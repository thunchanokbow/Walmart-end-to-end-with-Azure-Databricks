...
This project integrates data from websites using Azure Data Factory. The data is extracted in batches and transformed using Spark in Azure Databricks. The transformed data is stored in Synapse Analytics in columnar format. Finally, a dashboard is created using Looker Studio or Power BI, As a result of my project, juice has become their top-selling category! This will help with the decision to promote juices by placing them in more visible locations and on the website or application. Their most popular juice is Naked Juice, with customers picking up a total of 299 units daily. Each purchase involves different quantities and prices. With this information, the company is able to contact Naked's to order more juice and discuss pricing options.
## Project Overview
![0](/images/0.png)
